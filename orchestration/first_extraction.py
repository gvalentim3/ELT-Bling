...
from src.extraction import sales, sales_channels, sales_situations, products, product_categories
...
def main():
    ...
    sales_situations.extract_sales_situations(client=client, storage_bucket=bucket)
    products.products_extraction(client=client, storage_bucket=bucket)
    sales.sales_extraction(client=client, dataInicial="2025-01-01", dataFinal="2025-08-02", storage_bucket=bucket)
